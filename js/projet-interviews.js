    ...
    document.querySelectorAll('.clip-card').forEach(function(card, i){
      ...
      // Le widget SC gère lui-même la file d'attente des commandes (play,
      // seek...) tant que le lecteur n'est pas prêt : pas besoin d'attendre
      // l'événement "load" de l'iframe pour brancher le clic. En attendant
      // ça, le premier tap sur mobile arrivait avant que le clic soit
      // écouté et était perdu — d'où le besoin de taper deux fois.
